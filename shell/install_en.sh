...
acmeInstallSSL() {
    if [[ "${dnsSSLStatus}" == "true" ]]; then
        ...
        if [[ -n "${txtValue}" ]]; then
            ...
            echoContent yellow " ---> Please refer to this tutorial for adding method, https://github.com/wei3470231/v2ray-agent/blob/master/documents/dns_txt.md"
...
nginxBlog() {
    ...
    if [[ -d "${nginxStaticPath}" && -f "${nginxStaticPath}/check" ]]; then
        ...
        if [[ "${nginxBlogInstallStatus}" == "y" ]]; then
            ...
            wget -q -P "${nginxStaticPath}" https://raw.githubusercontent.com/wei3470231/v2ray-agent/master/fodder/blog/unable/html${randomNum}.zip >/dev/null
...
updateNginxBlog() {
    ...
    if [[ "${selectInstallNginxBlogType}" =~ ^[1-9]$ ]]; then
        ...
        wget -q -P "${nginxStaticPath}" "https://raw.githubusercontent.com/wei3470231/v2ray-agent/master/fodder/blog/unable/html${selectInstallNginxBlogType}.zip" >/dev/null
