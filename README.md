...
```
wget -P /root -N --no-check-certificate "https://raw.githubusercontent.com/wei3470231/v2ray-agent/master/install.sh" && chmod 700 /root/install.sh && /root/install.sh
```
...
### 安装Docker版
```
wget -P /root -N --no-check-certificate "https://raw.githubusercontent.com/wei3470231/v2ray-agent/master/shell/docker_reality.sh" && chmod 700 /root/docker_reality.sh && /root/docker_reality.sh
```
...
*   **反馈:** [提交 issue](https://github.com/wei3470231/v2ray-agent/issues)
