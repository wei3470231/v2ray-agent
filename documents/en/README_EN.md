...
```
bash wget -P /root -N --no-check-certificate "https://raw.githubusercontent.com/wei3470231/v2ray-agent/master/install.sh" && chmod 700 /root/install.sh && /root/install.sh
```
...
*   **Feedback:** [Submit an issue](https://github.com/wei3470231/v2ray-agent/issues)
